...
export const LinkedinIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6" {...props}><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
);
...
export const AKLogo = (props) => (
    <svg height="42" width="42" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" {...props}>
        <polygon points="50,0 100,25 100,75 50,100 0,75 0,25" stroke="currentColor" strokeWidth="5" fill="none" />
        <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="45" fontWeight="bold" fill="currentColor">
            AK
        </text>
    </svg>
);
